  ...
  return (
    <>
      ...
      <div style={{
        ...
        {/* Separador animado — igual que Servicios */}
      ...
      <div style={{ background: "#f0f4f8", padding: "clamp(3rem, 6vw, 5rem) 1.5rem" }}>
        <div style={{ maxWidth: "var(--max-width)", margin: "0 auto", width: "100%" }}>
          {loading ? (
            <div style={{
              textAlign: 'center', padding: '6rem 2rem', minHeight: '50vh',
              ...
              <p style={{ fontSize: '1.2rem', color: '#64748b', fontWeight: '500' }}>Cargando galería...</p>
            </div>
          ) : imagenes.length === 0 ? (
            <div style={{
              textAlign: 'center', padding: '6rem 2rem', minHeight: '50vh',
              display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center',
              background: 'white', borderRadius: '20px', boxShadow: '0 10px 40px rgba(59,130,246,0.1)'
            }}>
              <h3 style={{ fontSize: 'clamp(1.6rem, 3.5vw, 2.2rem)', color: '#0b1120', marginBottom: '1rem' }}>
                Aún no hay imágenes
              </h3>
            ...
            <>
              <div style={{ textAlign: 'center', marginBottom: 'clamp(2rem, 4vw, 3rem)' }}>
                <h2 style={{ fontSize: 'clamp(1.8rem, 4vw, 2.3rem)', color: '#0b1120', fontWeight: '700', marginBottom: '0.5rem' }}>
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              fontSize: '2.5rem', width: '55px', height: '55px',
          ...
          <div style={{
            ...
            <input
              ...
              style={{
                ...
                padding: '0.75rem', border: '2px dashed #3b82f6',
            ...
            {archivoSeleccionado && (
              <p style={{
                ...
                fontSize: '0.9rem', color: '#0369a1', marginBottom: '1.5rem'
              }}>
            ...
            <div style={{ display: 'flex', gap: '1rem', justifyContent: 'flex-end' }}>
              <button
                onClick={() => { setMostrarSubirModal(false); setArchivoSeleccionado(null); }}
                style={{
              ...
              <button
                ...
                style={{
                  ...
                  boxShadow: archivoSeleccionado ? '0 4px 15px rgba(59,130,246,0.4)' : 'none'
                }}
              >
                Subir imagen
              </button>
